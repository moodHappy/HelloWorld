...
3 ．Well, you're going to have roast beef and potatoes again tonight!
唉，今晚你们又要吃烤牛肉和土豆了！ 
...
这时的have是行为动词，所以与动作有关，而不像 have表示“具有”时（请参见 Lessons 59～ 60 语法部分）那样表示状态（如 I have〈got〉a car）。 
因此，它可以用于各种时态。如： 
...
当have不表示“有”而表示其他意思时，其用法和英语中的其他动词相同，
意即：在疑问和否定结构中，have的一般现在时和一般过去时形式必须用do，does和 did： 
